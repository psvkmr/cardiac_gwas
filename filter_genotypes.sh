...
#SBATCH --verbose
#SBATCH --output=/scratch/users/k2142172/tests/array/genotype_filt.out
...
--remove $remove_samples --extract $keep_snps --make-pgen --out ${out_dir}/genotype_filt
...
--extract ${out_dir}/LDprune_genotype.prune.in --make-pgen --out ${out_dir}/genotype_pruned 

wait 

plink2 --pfile ${out_dir}/genotype_pruned --memory 16000 --make-bed --out 
${out_dir}/genotype_pruned
