...
#SBATCH --job-name=dis_bgen
#SBATCH --time=04:00:00
#SBATCH --mem=24G
#SBATCH --ntasks=2
#SBATCH --cpus-per-task=8
#SBATCH --verbose
#SBATCH --output=/scratch/users/k2142172/tests/dis/bgen_%A_%a.out
#SBATCH --array=[1-22]%6
...
sample_file=/scratch/users/k2142172/outputs/cardiac_gwas/sample_ids/ukb_sqc_eur_disIDs_IID.txt
