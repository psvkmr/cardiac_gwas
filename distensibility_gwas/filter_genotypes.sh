...
#SBATCH --job-name=dis_genotype_filt
#SBATCH --time=02:00:00
#SBATCH --mem=16G
#SBATCH --ntasks=2
#SBATCH --cpus-per-task=8
#SBATCH --verbose
#SBATCH --output=/scratch/users/k2142172/tests/dis/genotype_filt.out
...
plink2 --bfile ${geno_data} --memory 16000 --threads 2 --keep $keep_samples --make-pgen --out ${out_dir}/genotype_filt

wait

plink2 --pfile ${out_dir}/genotype_filt --memory 16000 --indep-pairwise 500 50 0.2 --out ${out_dir}/LDprune_genotype 
